...
Alternative light Chromium OS77 https://github.com/Griggorii/Chromium_OS_77 best speed boot run system shell - жду идей по доработке что бы на ютубе заработал libffmpeg.so надо сделать в opt папке с chromium библиотеками спец линк типа sudo cp libffmpeg.so /opt/chromium && sudo ln -s /opt/chromium ./libs example support youtube html5 video , я предлагаю доработку этой операционной системы потому что я не собираюсь дарить гуглу эту операционную систему и другим компаниям по причине ограничение моих прав на российском сигменте девелопминга на такой платформе как youtube и отчуждение тем самым от моего канала инвестиции и потери прибыли из за руководящего состава youtube в россии по скольку такие вещи являются очень сложно создаваемыми и порой даже в единственном варианте.
