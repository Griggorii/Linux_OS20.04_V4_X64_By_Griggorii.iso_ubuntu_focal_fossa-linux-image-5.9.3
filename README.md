...
Этот дистрибутив делается очень сложно так что больше его распространяйте и чем больше узнает что такое качество и тогда может другие страны отпраят инвестиции и вообще зар платы за мой ручной труд и перестроение дистрибутива.
