...
Если появится ниже следующая проблема то лучше завести флешку с reefind чем решать теперь проблемму созданную разработчиками которой ранее не наблюдалось в версии 19.10
